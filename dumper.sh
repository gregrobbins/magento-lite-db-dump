...
mysqldump -u$USERNAME -p$PASSWORD $DBNAME -t  \
    ...
    --ignore-table $DBNAME.sales_order_status \
    --ignore-table $DBNAME.sales_order_status_label \
    --ignore-table $DBNAME.sales_order_status_state \
    ...
    --ignore-table $DBNAME.salesrule \
    --ignore-table $DBNAME.salesrule_coupon \
    --ignore-table $DBNAME.salesrule_coupon_usage \
    --ignore-table $DBNAME.salesrule_customer \
    --ignore-table $DBNAME.salesrule_customer_group \
    --ignore-table $DBNAME.salesrule_label \
    --ignore-table $DBNAME.salesrule_product_attribute \
    --ignore-table $DBNAME.salesrule_website \
